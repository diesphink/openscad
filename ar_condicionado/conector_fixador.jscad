...
"use strict"
  ...
  function conector_fixador() {
    ...
    var dim_tubo = {r: 153/2, h: 45, parede: 2}
    var dim_suporte = {parede: 3, projecao: 10, r_parafuso: 1.6}
    var fn = 48

    var tubo = cylinder({r: dim_tubo.r + dim_tubo.parede, h: dim_tubo.h, center: [true, true, false], fn: fn})
      .subtract(cylinder({r: dim_tubo.r, h: dim_tubo.h, center: [true, true, false], fn: fn}))
    var tubo = tubo
    ...
    var suporte_parafuso = cube({size: [dim_suporte.projecao, dim_suporte.parede, dim_tubo.h], radius:[1,1.5,0], fn: 32})
    suporte_parafuso = suporte_parafuso
