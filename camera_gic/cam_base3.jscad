...
base = (function() {
  ...
  function base() {
    ...
    var base = cube({
      size: [dim.base.x, dim.base.y, dim.base.z2],
      radius: [2, 2, 1],
      fn: dim.fn
    })

    base = base.union(cube({
      size: [dim.base.x + 2*dim.base.parede_grossa + 2*dim.base.raio_parafuso_grande, dim.base.y, dim.base.z],
      radius: [2, 2, 1],
      fn: dim.fn
    }))
    ...
    var ranhura1 = hull(
        ...
        circle(dim.slit.raio_parafuso).translate([0, dim.base.suporte.y - 2*dim.slit.raio_parafuso - 4*dim.base.parede_grossa, 0])
    )
    ...
    .extrude({ offset: [0, 0, dim.base.x] })
    .translate([dim.base.x + dim.base.parede_grossa, dim.base.parede_fina, 0])
