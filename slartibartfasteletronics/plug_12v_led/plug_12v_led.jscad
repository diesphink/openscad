plug_12v_led = (function() {
  ...
  function hollow() {
    ...
    .union(cube({size:[2, dim.r*2 + dim.folga * 2, dim.z * 3], center:[0, 1, 0]}).translate([37, 0, dim.parede + dim.r + (6 - dim.r)]))
    .union(cylinder({r: dim.r + dim.folga, h: 2, center: [true, true, false]}).rotateY(90).translate([37, 0, dim.parede + dim.r + (6 - dim.r)]))
