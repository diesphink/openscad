...
m3 = (function() {
  ...
  function m3({r = 1.5, h = 8, cabeca = {r: 3, h: 3}, protecao = {r: 4, h: 3}} = {}) {
    ...
    m3.properties.cabeca = cylinder(cabeca).align(m3, {
      center: [1, 1, 0],
      beginToEnd: [0, 0, 1]
    }).setColor([0.4, 0.1, 0.1, 0.5])

    m3.properties.protecao = cylinder({r: protecao.r, h: protecao.h, center: [1, 1, 0]})
      .subtract(cylinder({r: cabeca.r, h: protecao.h, center: [1, 1, 0]}))
      .align(m3, { center: [1, 1, 0], beginToEnd: [0, 0, 1] })
